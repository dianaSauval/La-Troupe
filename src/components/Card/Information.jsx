  ...
  return (
    ...
    >
      ...
      <MKBox mt={6}>
        ...
        <MKBox
          component="img"
          src="https://res.cloudinary.com/dkdhdy9e5/image/upload/v1737989804/La%20Troupe/WhatsApp_Image_2025-01-27_at_11.55.38_AM_d7ko5w.jpg" // Reemplaza con la ruta de tu imagen
          alt="Horarios"
          sx={{
